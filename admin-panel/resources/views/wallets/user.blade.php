                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <table class="table-borderless table-striped" aria-describedby="mydesc"
                                       id="table_list" data-toggle="table" data-url="{{ route('wallet.users.show') }}"
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" data-field="balance" data-align="center" data-sortable="false">{{ __('Balance') }}</th>
                                        <th scope="col" data-field="currency" data-align="center" data-sortable="false">{{ __('Currency') }}</th>
