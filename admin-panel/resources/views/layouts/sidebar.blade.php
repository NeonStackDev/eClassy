    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                @endcan
                @endcanany
                @canany(['user-wallet-list'])

                <div class="sidebar-new-title">{{ __('Wallet Management') }}</div>
                @can('user-wallet-list')
                <li class="sidebar-item sidebar-submenus">
                    <a href="{{ route('wallet.users.index') }}" class='sidebar-link'>
                        <i class="bi bi-person-badge-fill"></i>
                        <span class="menu-item">{{ __('User Wallet') }}</span>
                    </a>
                </li>
                @endcan
                @can('user-wallet-hostory-list')
                <li class="sidebar-item sidebar-submenus">
